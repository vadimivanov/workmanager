...
@Component({
  selector: 'app-supporter-password',
  templateUrl: './supporter-password.component.html',
  styleUrls: ['./supporter-password.component.scss']
})
export class SupporterPasswordComponent implements OnInit {
