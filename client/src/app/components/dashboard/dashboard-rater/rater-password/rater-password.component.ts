...
@Component({
  selector: 'app-rater-password',
  templateUrl: './rater-password.component.html',
  styleUrls: ['./rater-password.component.scss']
})
export class RaterPasswordComponent implements OnInit {
